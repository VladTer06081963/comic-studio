...
bot.command('help', async (ctx) => {
  ...
  const helpText =
    ...
    `• <b>Через кнопку ✏️</b> на карточке сценария — откроется режим ожидания правки\n` +
    `• <b>Через команду:</b> <code>/edit ID текст</code>\n` +
    `• <b>Несколько правок</b> — сохраняются как история\n` +
    `\n<b>Примеры правок:</b>\n` +
    `• <code>Убрать панель 2</code>\n` +
    `• <code>Сделать более смешным</code>\n` +
    `• <code>Добавить драмы в 3 панель</code>\n` +
    `• <code>Изменить концовку</code>\n` +
    `• <code>Добавить персонажа</code>\n\n` +
...
bot.on('text', async (ctx) => {
  ...
  if (text === 'ℹ️ Помощь') {
    ...
    const helpText =
      ...
      `• Отправь ID — откроется карточка сценария\n\n` +
      `<b>✏️ Редактирование сценария:</b>\n` +
      `• Кнопка ✏️ на сценарии — режим ожидания правки\n` +
      `• <code>/edit ID текст правки</code>\n` +
      `• Несколько правок сохраняются как история\n` +
      `\n<b>Примеры правок:</b>\n` +
      `• <code>Убрать панель 2</code>\n` +
      `• <code>Сделать более смешным</code>\n` +
      `• <code>Добавить драмы в 3 панель</code>\n` +
