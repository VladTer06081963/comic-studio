...
*Переименован в PRD-MVP.md: 2026-08-08*

**Расширения MVP, развитые после этой версии:**
- `PRD/HTML.md` — HTML rendering как primary artifact (2026-08-02)
- `PRD/AiPULT.md` — AI-чат функционал (2026-08-03)
- См. `summary/audit/` для истории всех изменений после MVP